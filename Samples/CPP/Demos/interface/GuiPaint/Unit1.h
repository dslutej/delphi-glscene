...
__published:	// IDE-managed Components
	...
	void __fastcall GLCanvasMouseDown(TObject *Sender, TGLMouseButton Button, TShiftState Shift,
          int X, int Y);
	void __fastcall GLCanvasMouseMove(TObject *Sender, TShiftState Shift, int X, int Y);
	void __fastcall GLCanvasMouseUp(TObject *Sender, TGLMouseButton Button, TShiftState Shift,
          int X, int Y);
