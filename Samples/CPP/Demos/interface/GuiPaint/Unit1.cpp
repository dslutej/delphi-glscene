...
void __fastcall TForm1::GLCanvasMouseDown(TObject *Sender, TGLMouseButton Button,
		  TShiftState Shift, int X, int Y)
{
  if (Button == Glcrossplatform::mbLeft)
  {
...
void __fastcall TForm1::GLCanvasMouseUp(TObject *Sender, TGLMouseButton Button, TShiftState Shift,
		  int X, int Y)
{
  if (Button == Glcrossplatform::mbLeft)
  {
...
void __fastcall TForm1::GLCanvasAcceptMouseQuery(TGLBaseControl *Sender, TShiftState Shift,
          TGLMouseAction Action, TGLMouseButton Button, int X, int Y, bool &Accept)
