...
Type
  ...
  public
    ...
    property RefractionTexture: TGLTexture read FRefractionTexture write SetRefractionTexTexture;
    property RefractionTextureName: TGLLibMaterialName read GetRefractionTexName write SetRefractionTexName;
    property OwnerObject : TGLBaseSceneObject read FOwnerObject write FOwnerObject;
